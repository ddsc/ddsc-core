...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MeasuringDevice'
        db.create_table(u'ddsc_core_measuringdevice', (
        ...
        db.send_create_signal(u'ddsc_core', ['MeasuringDevice'])


    def backwards(self, orm):
        # Deleting model 'MeasuringDevice'
        db.delete_table(u'ddsc_core_measuringdevice')
