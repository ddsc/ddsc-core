...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TimeseriesSelectionRule'
        db.create_table(u'ddsc_core_timeseriesselectionrule', (
        ...
        db.send_create_signal(u'ddsc_core', ['TimeseriesSelectionRule'])


    def backwards(self, orm):
        # Deleting model 'TimeseriesSelectionRule'
        db.delete_table(u'ddsc_core_timeseriesselectionrule')
    ...
    models = {
        ...
        u'ddsc_core.selectionrule': {
            'Meta': {'ordering': "[u'pk']", 'object_name': 'SelectionRule'},
