...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timeseries.owner'
        db.add_column(u'ddsc_core_timeseries', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-999, to=orm['lizard_security.DataOwner']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Timeseries.owner'
        db.delete_column(u'ddsc_core_timeseries', 'owner_id')
