...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Source'
        db.create_table(u'ddsc_core_source', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('source_type', self.gf('django.db.models.fields.SmallIntegerField')(default=1)),
            ('manufacturer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ddsc_core.Manufacturer'])),
            ('details', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'ddsc_core', ['Source'])

        # Adding unique constraint on 'Source', fields ['manufacturer', 'name']
        db.create_unique(u'ddsc_core_source', ['manufacturer_id', 'name'])

        # Adding model 'TimeseriesGroup'
        db.create_table(u'ddsc_core_timeseriesgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'ddsc_core', ['TimeseriesGroup'])

        # Adding M2M table for field sources on 'TimeseriesGroup'
        db.create_table(u'ddsc_core_timeseriesgroup_sources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('timeseriesgroup', models.ForeignKey(orm[u'ddsc_core.timeseriesgroup'], null=False)),
            ('source', models.ForeignKey(orm[u'ddsc_core.source'], null=False))
        ))
        db.create_unique(u'ddsc_core_timeseriesgroup_sources', ['timeseriesgroup_id', 'source_id'])

        # Adding M2M table for field parameters on 'TimeseriesGroup'
        db.create_table(u'ddsc_core_timeseriesgroup_parameters', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('timeseriesgroup', models.ForeignKey(orm[u'ddsc_core.timeseriesgroup'], null=False)),
            ('parameter', models.ForeignKey(orm[u'ddsc_core.parameter'], null=False))
        ))
        db.create_unique(u'ddsc_core_timeseriesgroup_parameters', ['timeseriesgroup_id', 'parameter_id'])

        # Adding model 'Manufacturer'
        db.create_table(u'ddsc_core_manufacturer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64)),
        ))
        db.send_create_signal(u'ddsc_core', ['Manufacturer'])

        # Adding field 'Timeseries.source'
        db.add_column(u'ddsc_core_timeseries', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-999, to=orm['ddsc_core.Source']),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Source', fields ['manufacturer', 'name']
        db.delete_unique(u'ddsc_core_source', ['manufacturer_id', 'name'])

        # Deleting model 'Source'
        db.delete_table(u'ddsc_core_source')

        # Deleting model 'TimeseriesGroup'
        db.delete_table(u'ddsc_core_timeseriesgroup')

        # Removing M2M table for field sources on 'TimeseriesGroup'
        db.delete_table('ddsc_core_timeseriesgroup_sources')

        # Removing M2M table for field parameters on 'TimeseriesGroup'
        db.delete_table('ddsc_core_timeseriesgroup_parameters')

        # Deleting model 'Manufacturer'
        db.delete_table(u'ddsc_core_manufacturer')

        # Deleting field 'Timeseries.source'
        db.delete_column(u'ddsc_core_timeseries', 'source_id')
