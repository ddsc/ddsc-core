...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogicalGroup.description'
        db.add_column(u'ddsc_core_logicalgroup', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding unique constraint on 'LogicalGroup', fields ['owner', 'name']
        db.create_unique(u'ddsc_core_logicalgroup', ['owner_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'LogicalGroup', fields ['owner', 'name']
        db.delete_unique(u'ddsc_core_logicalgroup', ['owner_id', 'name'])

        # Deleting field 'LogicalGroup.description'
        db.delete_column(u'ddsc_core_logicalgroup', 'description')
