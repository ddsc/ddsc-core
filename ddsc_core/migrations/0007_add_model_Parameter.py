...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ddsc_core_parameter', (
            ...
            ('cas_number', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('group', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('sikb_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True)),
        ))
        db.send_create_signal(u'ddsc_core', ['Parameter'])


    def backwards(self, orm):
        # Deleting model 'Parameter'
        db.delete_table(u'ddsc_core_parameter')
