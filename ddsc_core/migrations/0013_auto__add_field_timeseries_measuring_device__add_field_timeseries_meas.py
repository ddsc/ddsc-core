...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timeseries.measuring_device'
        db.add_column(u'ddsc_core_timeseries', 'measuring_device',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ddsc_core.MeasuringDevice'], null=True),
                      keep_default=False)

        # Adding field 'Timeseries.measuring_method'
        db.add_column(u'ddsc_core_timeseries', 'measuring_method',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ddsc_core.MeasuringMethod'], null=True),
                      keep_default=False)

        # Adding field 'Timeseries.processing_method'
        db.add_column(u'ddsc_core_timeseries', 'processing_method',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ddsc_core.ProcessingMethod'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Timeseries.measuring_device'
        db.delete_column(u'ddsc_core_timeseries', 'measuring_device_id')

        # Deleting field 'Timeseries.measuring_method'
        db.delete_column(u'ddsc_core_timeseries', 'measuring_method_id')

        # Deleting field 'Timeseries.processing_method'
        db.delete_column(u'ddsc_core_timeseries', 'processing_method_id')
    ...
    models = {
        ...
        u'ddsc_core.timeseries': {
            ...
            'measuring_device': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ddsc_core.MeasuringDevice']", 'null': 'True'}),
            'measuring_method': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ddsc_core.MeasuringMethod']", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'parameter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ddsc_core.Parameter']", 'null': 'True'}),
            'processing_method': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ddsc_core.ProcessingMethod']", 'null': 'True'}),
