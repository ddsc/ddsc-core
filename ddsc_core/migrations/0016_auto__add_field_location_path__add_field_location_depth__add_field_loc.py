...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ddsc_core_location', 'path',
                      self.gf('django.db.models.fields.CharField')(default='0001', unique=True, max_length=255),
                      keep_default=False)

        # Adding field 'Location.depth'
        db.add_column(u'ddsc_core_location', 'depth',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Location.numchild'
        db.add_column(u'ddsc_core_location', 'numchild',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.path'
        db.delete_column(u'ddsc_core_location', 'path')

        # Deleting field 'Location.depth'
        db.delete_column(u'ddsc_core_location', 'depth')

        # Deleting field 'Location.numchild'
        db.delete_column(u'ddsc_core_location', 'numchild')
