...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Source', fields ['name', 'manufacturer']
        db.delete_unique(u'ddsc_core_source', ['name', 'manufacturer_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'Source', fields ['name', 'manufacturer']
        db.create_unique(u'ddsc_core_source', ['name', 'manufacturer_id'])
