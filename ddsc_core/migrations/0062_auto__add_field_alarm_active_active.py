...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Alarm_Active.active'
        db.add_column(u'ddsc_core_alarm_active', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Alarm_Active.active'
        db.delete_column(u'ddsc_core_alarm_active', 'active')
