...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Folder'
        db.create_table(u'ddsc_core_folder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('path', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'ddsc_core', ['Folder'])

        # Adding model 'IPAddress'
        db.create_table(u'ddsc_core_ipaddress', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'ddsc_core', ['IPAddress'])


    def backwards(self, orm):
        # Deleting model 'Folder'
        db.delete_table(u'ddsc_core_folder')

        # Deleting model 'IPAddress'
        db.delete_table(u'ddsc_core_ipaddress')
