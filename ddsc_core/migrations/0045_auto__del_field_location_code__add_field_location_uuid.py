...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Location.code'
        db.delete_column(u'ddsc_core_location', 'code')

        # Adding field 'Location.uuid'
        db.add_column(u'ddsc_core_location', 'uuid',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Location.code'
        raise RuntimeError("Cannot reverse this migration. 'Location.code' and its values cannot be restored.")
        # Deleting field 'Location.uuid'
        db.delete_column(u'ddsc_core_location', 'uuid')
