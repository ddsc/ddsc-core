...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ddsc_core_logrecord', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('host', self.gf('django.db.models.fields.CharField')(max_length=64, db_index=True)),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('level', self.gf('django.db.models.fields.CharField')(max_length=8, db_index=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('line', self.gf('django.db.models.fields.SmallIntegerField')()),
        ))
        db.send_create_signal(u'ddsc_core', ['LogRecord'])


    def backwards(self, orm):
        # Deleting model 'LogRecord'
        db.delete_table(u'ddsc_core_logrecord')
