...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'LocationType', fields ['name']
        db.create_unique(u'ddsc_core_locationtype', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'LocationType', fields ['name']
        db.delete_unique(u'ddsc_core_locationtype', ['name'])
