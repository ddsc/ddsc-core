...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unit.source'
        db.add_column(u'ddsc_core_unit', 'source',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True),
                      keep_default=False)

        # Adding field 'Parameter.source'
        db.add_column(u'ddsc_core_parameter', 'source',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True),
                      keep_default=False)

        # Adding field 'Compartment.source'
        db.add_column(u'ddsc_core_compartment', 'source',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unit.source'
        db.delete_column(u'ddsc_core_unit', 'source')

        # Deleting field 'Parameter.source'
        db.delete_column(u'ddsc_core_parameter', 'source')

        # Deleting field 'Compartment.source'
        db.delete_column(u'ddsc_core_compartment', 'source')
