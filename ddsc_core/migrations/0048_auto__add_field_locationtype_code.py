...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationType.code'
        db.add_column(u'ddsc_core_locationtype', 'code',
                      self.gf('django.db.models.fields.CharField')(default='FOO', unique=True, max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocationType.code'
        db.delete_column(u'ddsc_core_locationtype', 'code')
