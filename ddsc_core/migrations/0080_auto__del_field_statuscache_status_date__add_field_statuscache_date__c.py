...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StatusCache.date'
        db.add_column(u'ddsc_core_statuscache', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


        # Changing field 'StatusCache.modify_timestamp'
        db.alter_column(u'ddsc_core_statuscache', 'modify_timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'StatusCache.date'
        db.delete_column(u'ddsc_core_statuscache', 'date')


        # Changing field 'StatusCache.modify_timestamp'
        db.alter_column(u'ddsc_core_statuscache', 'modify_timestamp', self.gf('django.db.models.fields.DateTimeField')())
