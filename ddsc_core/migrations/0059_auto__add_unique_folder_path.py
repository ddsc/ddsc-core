...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Folder', fields ['path']
        db.create_unique(u'ddsc_core_folder', ['path'])


    def backwards(self, orm):
        # Removing unique constraint on 'Folder', fields ['path']
        db.delete_unique(u'ddsc_core_folder', ['path'])
