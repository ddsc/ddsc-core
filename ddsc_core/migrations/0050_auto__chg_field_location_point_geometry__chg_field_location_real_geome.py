...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'ddsc_core_location', 'point_geometry', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=4258, null=True))

        # Changing field 'Location.real_geometry'
        db.alter_column(u'ddsc_core_location', 'real_geometry', self.gf('django.contrib.gis.db.models.fields.GeometryField')(srid=4258, null=True))
