...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field timeseries on 'LogicalGroup'
        db.create_table(u'ddsc_core_logicalgroup_timeseries', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('logicalgroup', models.ForeignKey(orm[u'ddsc_core.logicalgroup'], null=False)),
            ('timeseries', models.ForeignKey(orm[u'ddsc_core.timeseries'], null=False))
        ))
        db.create_unique(u'ddsc_core_logicalgroup_timeseries', ['logicalgroup_id', 'timeseries_id'])


    def backwards(self, orm):
        # Removing M2M table for field timeseries on 'LogicalGroup'
        db.delete_table('ddsc_core_logicalgroup_timeseries')
