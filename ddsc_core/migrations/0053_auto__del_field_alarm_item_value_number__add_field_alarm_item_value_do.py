...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Alarm_Item.value_double'
        db.add_column(u'ddsc_core_alarm_item', 'value_double',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Alarm_Item.value_int'
        db.add_column(u'ddsc_core_alarm_item', 'value_int',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Alarm_Item.value_bool'
        db.add_column(u'ddsc_core_alarm_item', 'value_bool',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Alarm_Item.value_double'
        db.delete_column(u'ddsc_core_alarm_item', 'value_double')

        # Deleting field 'Alarm_Item.value_int'
        db.delete_column(u'ddsc_core_alarm_item', 'value_int')

        # Deleting field 'Alarm_Item.value_bool'
        db.delete_column(u'ddsc_core_alarm_item', 'value_bool')
