...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Manufacturer.code'
        db.add_column(u'ddsc_core_manufacturer', 'code',
                      self.gf('django.db.models.fields.CharField')(default='XXX', unique=True, max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Manufacturer.code'
        db.delete_column(u'ddsc_core_manufacturer', 'code')
