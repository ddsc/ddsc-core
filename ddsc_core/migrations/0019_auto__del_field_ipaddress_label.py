...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IPAddress.label'
        db.delete_column(u'ddsc_core_ipaddress', 'label')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'IPAddress.label'
        raise RuntimeError("Cannot reverse this migration. 'IPAddress.label' and its values cannot be restored.")
