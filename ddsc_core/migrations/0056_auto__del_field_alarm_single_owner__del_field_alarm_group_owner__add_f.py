...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Alarm.single_or_group'
        db.add_column(u'ddsc_core_alarm', 'single_or_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Alarm.object_id'
        db.add_column(u'ddsc_core_alarm', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


        # Changing field 'Alarm.description'
        db.alter_column(u'ddsc_core_alarm', 'description', self.gf('django.db.models.fields.TextField')(null=True))
        # Deleting field 'Alarm_Item.timeseries'
        db.delete_column(u'ddsc_core_alarm_item', 'timeseries_id')

        # Deleting field 'Alarm_Item.location'
        db.delete_column(u'ddsc_core_alarm_item', 'location_id')

        # Deleting field 'Alarm_Item.logicalgroup'
        db.delete_column(u'ddsc_core_alarm_item', 'logicalgroup_id')

        # Adding field 'Alarm_Item.alarm_type'
        db.add_column(u'ddsc_core_alarm_item', 'alarm_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Alarm_Item.object_id'
        db.add_column(u'ddsc_core_alarm_item', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Alarm_Item.logical_check'
        db.add_column(u'ddsc_core_alarm_item', 'logical_check',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Alarm.single_or_group'
        db.delete_column(u'ddsc_core_alarm', 'single_or_group_id')

        # Deleting field 'Alarm.object_id'
        db.delete_column(u'ddsc_core_alarm', 'object_id')


        # Changing field 'Alarm.description'
        db.alter_column(u'ddsc_core_alarm', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=20))
        ...
        # Adding field 'Alarm_Item.location'
        db.add_column(u'ddsc_core_alarm_item', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ddsc_core.Location'], null=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Alarm_Item.alarm_type'
        db.delete_column(u'ddsc_core_alarm_item', 'alarm_type_id')

        # Deleting field 'Alarm_Item.object_id'
        db.delete_column(u'ddsc_core_alarm_item', 'object_id')

        # Deleting field 'Alarm_Item.logical_check'
        db.delete_column(u'ddsc_core_alarm_item', 'logical_check')
