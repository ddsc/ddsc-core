...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Timeseries.code'
        db.delete_column(u'ddsc_core_timeseries', 'code')

        # Adding field 'Timeseries.uuid'
        db.add_column(u'ddsc_core_timeseries', 'uuid',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Timeseries.code'
        raise RuntimeError("Cannot reverse this migration. 'Timeseries.code' and its values cannot be restored.")
        # Deleting field 'Timeseries.uuid'
        db.delete_column(u'ddsc_core_timeseries', 'uuid')
