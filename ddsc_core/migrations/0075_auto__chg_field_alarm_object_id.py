...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Alarm.object_id'
        db.alter_column(u'ddsc_core_alarm', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Alarm.object_id'
        raise RuntimeError("Cannot reverse this migration. 'Alarm.object_id' and its values cannot be restored.")
    ...
    models = {
        ...
        u'ddsc_core.location': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 15, 0, 0)'}),
