...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.owner'
        db.add_column(u'ddsc_core_source', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_security.DataOwner'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.owner'
        db.add_column(u'ddsc_core_location', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_security.DataOwner'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source.owner'
        db.delete_column(u'ddsc_core_source', 'owner_id')

        # Deleting field 'Location.owner'
        db.delete_column(u'ddsc_core_location', 'owner_id')
    ...
    models = {
        ...
        u'ddsc_core.location': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 17, 0, 0)'}),
