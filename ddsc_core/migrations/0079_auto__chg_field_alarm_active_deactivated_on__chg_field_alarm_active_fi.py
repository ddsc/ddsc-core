...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Alarm_Active.deactivated_on'
        db.alter_column(u'ddsc_core_alarm_active', 'deactivated_on', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Alarm_Active.first_triggered_on'
        db.alter_column(u'ddsc_core_alarm_active', 'first_triggered_on', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Alarm_Active.deactivated_on'
        db.alter_column(u'ddsc_core_alarm_active', 'deactivated_on', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Alarm_Active.first_triggered_on'
        db.alter_column(u'ddsc_core_alarm_active', 'first_triggered_on', self.gf('django.db.models.fields.DateTimeField')())
