...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StatusCache.first_measurement_timestamp'
        db.delete_column(u'ddsc_core_statuscache', 'first_measurement_timestamp')

        # Adding field 'StatusCache.modify_timestamp'
        db.add_column(u'ddsc_core_statuscache', 'modify_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1900, 1, 1, 0, 0)),
                      keep_default=False)

        # Adding field 'StatusCache.status_date'
        db.add_column(u'ddsc_core_statuscache', 'status_date',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'StatusCache.first_measurement_timestamp'
        db.add_column(u'ddsc_core_statuscache', 'first_measurement_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1900, 1, 1, 0, 0)),
                      keep_default=False)

        # Deleting field 'StatusCache.modify_timestamp'
        db.delete_column(u'ddsc_core_statuscache', 'modify_timestamp')

        # Deleting field 'StatusCache.status_date'
        db.delete_column(u'ddsc_core_statuscache', 'status_date')
