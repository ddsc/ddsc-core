...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'IPAddress.label2'
        raise RuntimeError("Cannot reverse this migration. 'IPAddress.label2' and its values cannot be restored.")
