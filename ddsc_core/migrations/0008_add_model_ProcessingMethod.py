...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProcessingMethod'
        db.create_table(u'ddsc_core_processingmethod', (
        ...
        db.send_create_signal(u'ddsc_core', ['ProcessingMethod'])


    def backwards(self, orm):
        # Deleting model 'ProcessingMethod'
        db.delete_table(u'ddsc_core_processingmethod')
