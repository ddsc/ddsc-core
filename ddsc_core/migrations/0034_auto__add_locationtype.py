...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ddsc_core_locationtype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ))
        db.send_create_signal(u'ddsc_core', ['LocationType'])

        # Adding M2M table for field locations on 'LocationType'
        db.create_table(u'ddsc_core_locationtype_locations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('locationtype', models.ForeignKey(orm[u'ddsc_core.locationtype'], null=False)),
            ('location', models.ForeignKey(orm[u'ddsc_core.location'], null=False))
        ))
        db.create_unique(u'ddsc_core_locationtype_locations', ['locationtype_id', 'location_id'])


    def backwards(self, orm):
        # Deleting model 'LocationType'
        db.delete_table(u'ddsc_core_locationtype')

        # Removing M2M table for field locations on 'LocationType'
        db.delete_table('ddsc_core_locationtype_locations')
