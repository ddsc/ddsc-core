...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Alarm_Item.first_born'
        db.add_column(u'ddsc_core_alarm_item', 'first_born',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Alarm_Item.first_born'
        db.delete_column(u'ddsc_core_alarm_item', 'first_born')
