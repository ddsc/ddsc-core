...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Alarm_Active'
        db.create_table(u'ddsc_core_alarm_active', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alarm', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ddsc_core.Alarm'])),
            ('first_triggered_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1900, 1, 1, 0, 0))),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('deactivated_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1900, 1, 1, 0, 0))),
        ))
        db.send_create_signal(u'ddsc_core', ['Alarm_Active'])


    def backwards(self, orm):
        # Deleting model 'Alarm_Active'
        db.delete_table(u'ddsc_core_alarm_active')
