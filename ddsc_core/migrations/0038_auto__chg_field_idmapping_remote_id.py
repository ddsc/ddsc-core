...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IdMapping.remote_id'
        db.alter_column(u'ddsc_core_idmapping', 'remote_id', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'IdMapping.remote_id'
        db.alter_column(u'ddsc_core_idmapping', 'remote_id', self.gf('django.db.models.fields.IntegerField')())
