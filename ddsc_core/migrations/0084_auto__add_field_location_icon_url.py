...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.icon_url'
        db.add_column(u'ddsc_core_location', 'icon_url',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.icon_url'
        db.delete_column(u'ddsc_core_location', 'icon_url')
    ...
    models = {
        ...
        u'ddsc_core.alarm': {
            ...
            'single_or_group': ('django.db.models.fields.related.ForeignKey', [], {'default': '5', 'to': u"orm['contenttypes.ContentType']"}),
        ...
        u'ddsc_core.alarm_item': {
            ...
            'alarm': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ddsc_core.Alarm']"}),
            'alarm_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['contenttypes.ContentType']"}),
        ...
        u'ddsc_core.location': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 18, 0, 0)'}),
            'depth': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'geometry_precision': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'icon_url': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80', 'db_index': 'True'}),
            'numchild': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lizard_security.DataOwner']", 'null': 'True', 'blank': 'True'}),
        ...
        u'ddsc_core.logicalgroup': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lizard_security.DataOwner']"}),
        ...
        u'ddsc_core.timeseries': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 18, 0, 0)'}),
            'data_set': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "u'timeseries'", 'blank': 'True', 'to': u"orm['lizard_security.DataSet']"}),
            ...
            'supplying_systems': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'symmetrical': 'False', 'through': u"orm['ddsc_core.IdMapping']", 'blank': 'True'}),
        ...
        u'lizard_security.dataowner': {
            'Meta': {'ordering': "['name']", 'object_name': 'DataOwner'},
            'data_managers': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'symmetrical': 'False', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
