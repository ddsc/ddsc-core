...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.real_geometry'
        db.alter_column(u'ddsc_core_location', 'real_geometry', self.gf('django.contrib.gis.db.models.fields.GeometryField')(null=True))

        # Changing field 'Location.point_geometry'
        db.alter_column(u'ddsc_core_location', 'point_geometry', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True))

    def backwards(self, orm):

        # Changing field 'Location.real_geometry'
        db.alter_column(u'ddsc_core_location', 'real_geometry', self.gf('django.contrib.gis.db.models.fields.GeometryField')(dim=3, null=True))

        # Changing field 'Location.point_geometry'
        db.alter_column(u'ddsc_core_location', 'point_geometry', self.gf('django.contrib.gis.db.models.fields.PointField')(dim=3, null=True))
