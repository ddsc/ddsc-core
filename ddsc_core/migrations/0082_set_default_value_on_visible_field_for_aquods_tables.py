...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute('ALTER TABLE "ddsc_core_compartment" ALTER COLUMN "visible" SET DEFAULT false')
        db.execute('ALTER TABLE "ddsc_core_measuringdevice" ALTER COLUMN "visible" SET DEFAULT false')
        db.execute('ALTER TABLE "ddsc_core_measuringmethod" ALTER COLUMN "visible" SET DEFAULT false')
        db.execute('ALTER TABLE "ddsc_core_parameter" ALTER COLUMN "visible" SET DEFAULT false')
        db.execute('ALTER TABLE "ddsc_core_processingmethod" ALTER COLUMN "visible" SET DEFAULT false')
        db.execute('ALTER TABLE "ddsc_core_referenceframe" ALTER COLUMN "visible" SET DEFAULT false')
        db.execute('ALTER TABLE "ddsc_core_unit" ALTER COLUMN "visible" SET DEFAULT false')

    def backwards(self, orm):
        db.execute('ALTER TABLE "ddsc_core_compartment" ALTER COLUMN "visible" DROP DEFAULT')
        db.execute('ALTER TABLE "ddsc_core_measuringdevice" ALTER COLUMN "visible" DROP DEFAULT')
        db.execute('ALTER TABLE "ddsc_core_measuringmethod" ALTER COLUMN "visible" DROP DEFAULT')
        db.execute('ALTER TABLE "ddsc_core_parameter" ALTER COLUMN "visible" DROP DEFAULT')
        db.execute('ALTER TABLE "ddsc_core_processingmethod" ALTER COLUMN "visible" DROP DEFAULT')
        db.execute('ALTER TABLE "ddsc_core_referenceframe" ALTER COLUMN "visible" DROP DEFAULT')
        db.execute('ALTER TABLE "ddsc_core_unit" ALTER COLUMN "visible" DROP DEFAULT')
    ...
    models = {
        ...
        u'ddsc_core.location': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 24, 0, 0)'}),
