...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StatusCache'
        db.create_table(u'ddsc_core_statuscache', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timeseries', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ddsc_core.Timeseries'])),
            ('nr_of_measurements_total', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('nr_of_measurements_reliable', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('nr_of_measurements_doubtful', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('nr_of_measurements_unreliable', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('first_measurement_timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1900, 1, 1, 0, 0))),
            ('min_val', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('max_val', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('mean_val', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('std_val', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'ddsc_core', ['StatusCache'])


    def backwards(self, orm):
        # Deleting model 'StatusCache'
        db.delete_table(u'ddsc_core_statuscache')
    ...
    models = {
        ...
        u'ddsc_core.statuscache': {
            ...
            'first_measurement_timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(1900, 1, 1, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
