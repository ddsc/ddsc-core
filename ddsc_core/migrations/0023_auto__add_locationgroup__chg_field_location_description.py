...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LocationGroup'
        db.create_table(u'ddsc_core_locationgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ))
        db.send_create_signal(u'ddsc_core', ['LocationGroup'])

        # Adding M2M table for field locations on 'LocationGroup'
        db.create_table(u'ddsc_core_locationgroup_locations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('locationgroup', models.ForeignKey(orm[u'ddsc_core.locationgroup'], null=False)),
            ('location', models.ForeignKey(orm[u'ddsc_core.location'], null=False))
        ))
        db.create_unique(u'ddsc_core_locationgroup_locations', ['locationgroup_id', 'location_id'])


        # Changing field 'Location.description'
        db.alter_column(u'ddsc_core_location', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting model 'LocationGroup'
        db.delete_table(u'ddsc_core_locationgroup')

        # Removing M2M table for field locations on 'LocationGroup'
        db.delete_table('ddsc_core_locationgroup_locations')


        # Changing field 'Location.description'
        db.alter_column(u'ddsc_core_location', 'description', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'ddsc_core.locationgroup': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locations': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['ddsc_core.Location']", 'symmetrical': 'False', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80'})
        },
