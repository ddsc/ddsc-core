...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.relative_location'
        db.add_column(u'ddsc_core_location', 'relative_location',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.relative_location'
        db.delete_column(u'ddsc_core_location', 'relative_location')
