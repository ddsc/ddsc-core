...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Alarm.previous_id'
        db.delete_column(u'ddsc_core_alarm', 'previous_id')

        # Adding field 'Alarm.previous_alarm'
        db.add_column(u'ddsc_core_alarm', 'previous_alarm',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ddsc_core.Alarm'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Alarm.previous_id'
        db.add_column(u'ddsc_core_alarm', 'previous_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Alarm.previous_alarm'
        db.delete_column(u'ddsc_core_alarm', 'previous_alarm_id')
