...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.show_on_map'
        db.add_column(u'ddsc_core_location', 'show_on_map',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.show_on_map'
        db.delete_column(u'ddsc_core_location', 'show_on_map')
