...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.frequency'
        db.add_column(u'ddsc_core_source', 'frequency',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source.timeout'
        db.add_column(u'ddsc_core_source', 'timeout',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source.frequency'
        db.delete_column(u'ddsc_core_source', 'frequency')

        # Deleting field 'Source.timeout'
        db.delete_column(u'ddsc_core_source', 'timeout')
