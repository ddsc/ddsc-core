...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Timeseries.validate_max_diff'
        db.delete_column(u'ddsc_core_timeseries', 'validate_max_diff')

        # Adding field 'Timeseries.validate_diff_hard'
        db.add_column(u'ddsc_core_timeseries', 'validate_diff_hard',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Timeseries.validate_diff_soft'
        db.add_column(u'ddsc_core_timeseries', 'validate_diff_soft',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Timeseries.validate_max_hard'
        db.alter_column(u'ddsc_core_timeseries', 'validate_max_hard', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Timeseries.validate_min_hard'
        db.alter_column(u'ddsc_core_timeseries', 'validate_min_hard', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Timeseries.validate_max_soft'
        db.alter_column(u'ddsc_core_timeseries', 'validate_max_soft', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Timeseries.validate_min_soft'
        db.alter_column(u'ddsc_core_timeseries', 'validate_min_soft', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):
        # Adding field 'Timeseries.validate_max_diff'
        db.add_column(u'ddsc_core_timeseries', 'validate_max_diff',
                      self.gf('django.db.models.fields.FloatField')(default=9999),
                      keep_default=False)

        # Deleting field 'Timeseries.validate_diff_hard'
        db.delete_column(u'ddsc_core_timeseries', 'validate_diff_hard')

        # Deleting field 'Timeseries.validate_diff_soft'
        db.delete_column(u'ddsc_core_timeseries', 'validate_diff_soft')


        # Changing field 'Timeseries.validate_max_hard'
        db.alter_column(u'ddsc_core_timeseries', 'validate_max_hard', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Timeseries.validate_min_hard'
        db.alter_column(u'ddsc_core_timeseries', 'validate_min_hard', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Timeseries.validate_max_soft'
        db.alter_column(u'ddsc_core_timeseries', 'validate_max_soft', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Timeseries.validate_min_soft'
        db.alter_column(u'ddsc_core_timeseries', 'validate_min_soft', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        u'ddsc_core.alarm': {
            ...
            'owner_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_security.UserGroup']"}),
            'owner_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'previous_id': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
        ...
        u'ddsc_core.alarm_iterm': {
            'Meta': {'object_name': 'Alarm_Iterm'},
        ...
        u'ddsc_core.alarm_iterm_details': {
            'Meta': {'object_name': 'Alarm_Iterm_Details'},
            'alarm_details': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['ddsc_core.Alarm_Iterm']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'ddsc_core.location': {
            ...
            'point_geometry': ('django.contrib.gis.db.models.fields.PointField', [], {'null': 'True', 'blank': 'True'}),
            'real_geometry': ('django.contrib.gis.db.models.fields.GeometryField', [], {'null': 'True', 'blank': 'True'})
        },
