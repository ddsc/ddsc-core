...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Alarm'
        db.create_table(u'ddsc_core_alarm', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('owner_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_security.UserGroup'])),
            ...
            ('template', self.gf('django.db.models.fields.TextField')(default=u'this is a alarm message template')),
            ('urgency', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('logical_check', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ('message_type', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('previous_id', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('active_stutus', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_created', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'ddsc_core', ['Alarm'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'ddsc_core_alarm')
