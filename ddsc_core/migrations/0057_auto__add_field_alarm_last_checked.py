...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Alarm.last_checked'
        db.add_column(u'ddsc_core_alarm', 'last_checked',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1900, 1, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Alarm.last_checked'
        db.delete_column(u'ddsc_core_alarm', 'last_checked')
