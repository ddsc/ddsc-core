...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timeseries.created'
        db.add_column(u'ddsc_core_timeseries', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=utcnow()),
                      keep_default=False)

        # Adding field 'Source.created'
        db.add_column(u'ddsc_core_source', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=utcnow()),
                      keep_default=False)

        # Adding field 'Location.created'
        db.add_column(u'ddsc_core_location', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=utcnow()),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Timeseries.created'
        db.delete_column(u'ddsc_core_timeseries', 'created')

        # Deleting field 'Source.created'
        db.delete_column(u'ddsc_core_source', 'created')

        # Deleting field 'Location.created'
        db.delete_column(u'ddsc_core_location', 'created')
    ...
    models = {
        ...
        u'ddsc_core.location': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 3, 0, 0)'}),
