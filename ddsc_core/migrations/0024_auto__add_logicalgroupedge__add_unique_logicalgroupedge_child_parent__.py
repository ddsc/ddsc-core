...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LogicalGroupEdge'
        db.create_table(u'ddsc_core_logicalgroupedge', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('child', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'childs', to=orm['ddsc_core.LogicalGroup'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'parents', to=orm['ddsc_core.LogicalGroup'])),
        ))
        db.send_create_signal(u'ddsc_core', ['LogicalGroupEdge'])

        # Adding unique constraint on 'LogicalGroupEdge', fields ['child', 'parent']
        db.create_unique(u'ddsc_core_logicalgroupedge', ['child_id', 'parent_id'])

        # Adding model 'LogicalGroup'
        db.create_table(u'ddsc_core_logicalgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'ddsc_core', ['LogicalGroup'])


    def backwards(self, orm):
        # Removing unique constraint on 'LogicalGroupEdge', fields ['child', 'parent']
        db.delete_unique(u'ddsc_core_logicalgroupedge', ['child_id', 'parent_id'])

        # Deleting model 'LogicalGroupEdge'
        db.delete_table(u'ddsc_core_logicalgroupedge')

        # Deleting model 'LogicalGroup'
        db.delete_table(u'ddsc_core_logicalgroup')
