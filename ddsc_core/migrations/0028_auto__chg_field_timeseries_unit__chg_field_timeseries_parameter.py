...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Timeseries.unit'
        db.alter_column(u'ddsc_core_timeseries', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-999, to=orm['ddsc_core.Unit']))

        # Changing field 'Timeseries.parameter'
        db.alter_column(u'ddsc_core_timeseries', 'parameter_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-999, to=orm['ddsc_core.Parameter']))

    def backwards(self, orm):

        # Changing field 'Timeseries.unit'
        db.alter_column(u'ddsc_core_timeseries', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ddsc_core.Unit'], null=True))

        # Changing field 'Timeseries.parameter'
        db.alter_column(u'ddsc_core_timeseries', 'parameter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ddsc_core.Parameter'], null=True))
