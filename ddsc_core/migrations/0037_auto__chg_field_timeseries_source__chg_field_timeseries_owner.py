...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Timeseries.source'
        db.alter_column(u'ddsc_core_timeseries', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ddsc_core.Source'], null=True))

        # Changing field 'Timeseries.owner'
        db.alter_column(u'ddsc_core_timeseries', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_security.DataOwner'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Timeseries.source'
        raise RuntimeError("Cannot reverse this migration. 'Timeseries.source' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Timeseries.owner'
        raise RuntimeError("Cannot reverse this migration. 'Timeseries.owner' and its values cannot be restored.")
