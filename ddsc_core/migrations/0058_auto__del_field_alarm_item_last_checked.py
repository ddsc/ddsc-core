...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Alarm_Item.last_checked'
        db.delete_column(u'ddsc_core_alarm_item', 'last_checked')


    def backwards(self, orm):
        # Adding field 'Alarm_Item.last_checked'
        db.add_column(u'ddsc_core_alarm_item', 'last_checked',
