...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timeseries.validate_max_hard'
        db.add_column(u'ddsc_core_timeseries', 'validate_max_hard',
                      self.gf('django.db.models.fields.FloatField')(default=9999),
                      keep_default=False)

        # Adding field 'Timeseries.validate_min_hard'
        db.add_column(u'ddsc_core_timeseries', 'validate_min_hard',
                      self.gf('django.db.models.fields.FloatField')(default=9999),
                      keep_default=False)

        # Adding field 'Timeseries.validate_max_soft'
        db.add_column(u'ddsc_core_timeseries', 'validate_max_soft',
                      self.gf('django.db.models.fields.FloatField')(default=9999),
                      keep_default=False)

        # Adding field 'Timeseries.validate_min_soft'
        db.add_column(u'ddsc_core_timeseries', 'validate_min_soft',
                      self.gf('django.db.models.fields.FloatField')(default=9999),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Timeseries.validate_max_hard'
        db.delete_column(u'ddsc_core_timeseries', 'validate_max_hard')

        # Deleting field 'Timeseries.validate_min_hard'
        db.delete_column(u'ddsc_core_timeseries', 'validate_min_hard')

        # Deleting field 'Timeseries.validate_max_soft'
        db.delete_column(u'ddsc_core_timeseries', 'validate_max_soft')

        # Deleting field 'Timeseries.validate_min_soft'
        db.delete_column(u'ddsc_core_timeseries', 'validate_min_soft')
