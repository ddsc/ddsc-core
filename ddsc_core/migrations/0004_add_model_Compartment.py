...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ddsc_core_compartment', (
            ...
            ('numeric_code', self.gf('django.db.models.fields.CharField')(max_length=12, null=True)),
        ))
        db.send_create_signal(u'ddsc_core', ['Compartment'])


    def backwards(self, orm):
        # Deleting model 'Compartment'
        db.delete_table(u'ddsc_core_compartment')
