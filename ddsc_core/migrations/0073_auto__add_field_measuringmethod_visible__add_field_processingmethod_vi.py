...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeasuringMethod.visible'
        db.add_column(u'ddsc_core_measuringmethod', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProcessingMethod.visible'
        db.add_column(u'ddsc_core_processingmethod', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MeasuringDevice.visible'
        db.add_column(u'ddsc_core_measuringdevice', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Unit.visible'
        db.add_column(u'ddsc_core_unit', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ReferenceFrame.visible'
        db.add_column(u'ddsc_core_referenceframe', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Parameter.visible'
        db.add_column(u'ddsc_core_parameter', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Parameter.cas_number'
        db.alter_column(u'ddsc_core_parameter', 'cas_number', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

        # Changing field 'Parameter.group'
        db.alter_column(u'ddsc_core_parameter', 'group', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))
        # Adding field 'Compartment.visible'
        db.add_column(u'ddsc_core_compartment', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MeasuringMethod.visible'
        db.delete_column(u'ddsc_core_measuringmethod', 'visible')

        # Deleting field 'ProcessingMethod.visible'
        db.delete_column(u'ddsc_core_processingmethod', 'visible')

        # Deleting field 'MeasuringDevice.visible'
        db.delete_column(u'ddsc_core_measuringdevice', 'visible')

        # Deleting field 'Unit.visible'
        db.delete_column(u'ddsc_core_unit', 'visible')

        # Deleting field 'ReferenceFrame.visible'
        db.delete_column(u'ddsc_core_referenceframe', 'visible')

        # Deleting field 'Parameter.visible'
        db.delete_column(u'ddsc_core_parameter', 'visible')


        # User chose to not deal with backwards NULL issues for 'Parameter.cas_number'
        raise RuntimeError("Cannot reverse this migration. 'Parameter.cas_number' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Parameter.group'
        raise RuntimeError("Cannot reverse this migration. 'Parameter.group' and its values cannot be restored.")
        # Deleting field 'Compartment.visible'
        db.delete_column(u'ddsc_core_compartment', 'visible')
    ...
    models = {
        ...
        u'ddsc_core.alarm': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_checked': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(1900, 1, 1, 0, 0)'}),
