...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SelectionRule'
        db.create_table(u'ddsc_core_selectionrule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ddsc_core.LogicalGroup'])),
            ('operator', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('criterion', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal(u'ddsc_core', ['SelectionRule'])


    def backwards(self, orm):
        # Deleting model 'SelectionRule'
        db.delete_table(u'ddsc_core_selectionrule')
    ...
    models = {
        ...
        u'ddsc_core.selectionrule': {
            'Meta': {'object_name': 'SelectionRule'},
            'criterion': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ddsc_core.LogicalGroup']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
