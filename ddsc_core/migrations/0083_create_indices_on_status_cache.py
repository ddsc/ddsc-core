...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'StatusCache', fields ['nr_of_measurements_reliable']
        db.create_index(u'ddsc_core_statuscache', ['nr_of_measurements_reliable'])

        # Adding index on 'StatusCache', fields ['nr_of_measurements_total']
        db.create_index(u'ddsc_core_statuscache', ['nr_of_measurements_total'])

        # Adding index on 'StatusCache', fields ['nr_of_measurements_unreliable']
        db.create_index(u'ddsc_core_statuscache', ['nr_of_measurements_unreliable'])

        # Adding index on 'StatusCache', fields ['date']
        db.create_index(u'ddsc_core_statuscache', ['date'])

        # Adding index on 'StatusCache', fields ['nr_of_measurements_doubtful']
        db.create_index(u'ddsc_core_statuscache', ['nr_of_measurements_doubtful'])


    def backwards(self, orm):
        # Removing index on 'StatusCache', fields ['nr_of_measurements_doubtful']
        db.delete_index(u'ddsc_core_statuscache', ['nr_of_measurements_doubtful'])

        # Removing index on 'StatusCache', fields ['date']
        db.delete_index(u'ddsc_core_statuscache', ['date'])

        # Removing index on 'StatusCache', fields ['nr_of_measurements_unreliable']
        db.delete_index(u'ddsc_core_statuscache', ['nr_of_measurements_unreliable'])

        # Removing index on 'StatusCache', fields ['nr_of_measurements_total']
        db.delete_index(u'ddsc_core_statuscache', ['nr_of_measurements_total'])

        # Removing index on 'StatusCache', fields ['nr_of_measurements_reliable']
        db.delete_index(u'ddsc_core_statuscache', ['nr_of_measurements_reliable'])
    ...
    models = {
        ...
        u'ddsc_core.alarm_active': {
            ...
            'first_triggered_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'ddsc_core.compartment': {
            ...
            'group': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'numeric_code': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'source': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
        ...
        u'ddsc_core.location': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 31, 0, 0)'}),
        ...
        u'ddsc_core.measuringmethod': {
            ...
            'group': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'titel': ('django.db.models.fields.CharField', [], {'max_length': '600', 'null': 'True', 'blank': 'True'}),
            'visible': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'ddsc_core.parameter': {
            'Meta': {'ordering': "[u'description']", 'object_name': 'Parameter'},
            'begin_date': ('django.db.models.fields.DateField', [], {}),
            'cas_number': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '12'}),
            'description': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '60'}),
            'end_date': ('django.db.models.fields.DateField', [], {}),
            'group': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sikb_id': ('django.db.models.fields.IntegerField', [], {'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'source': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'visible': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        ...
        u'ddsc_core.statuscache': {
            ...
            'nr_of_measurements_doubtful': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'nr_of_measurements_reliable': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'nr_of_measurements_total': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'nr_of_measurements_unreliable': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'ddsc_core.unit': {
            ...
            'begin_date': ('django.db.models.fields.DateField', [], {}),
            'code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '12'}),
            'conversion_factor': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '60'}),
            'dimension': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {}),
            'group': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
